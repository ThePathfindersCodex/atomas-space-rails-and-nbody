...
func get_center():
	 return Transform2D(rotation,position).xform(center-pivot)
func get_pivot():
	 return position	
func get_focus1():
	 return Transform2D(rotation,position).xform(focus1Pos-pivot)
func get_focus2():
	 return Transform2D(rotation,position).xform(focus2Pos-pivot)
func get_v1():
	 return Transform2D(rotation,position).xform(v1-pivot)
func get_v2():
	 return Transform2D(rotation,position).xform(v2-pivot)
func get_v3():
	 return Transform2D(rotation,position).xform(v3-pivot)
func get_v4():
	 return Transform2D(rotation,position).xform(v4-pivot)
